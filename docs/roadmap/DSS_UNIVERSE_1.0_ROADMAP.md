...
**Status: active.** Packages 10.0–10.13 establish the frozen product contracts,
...
Reddit-like comment trees, unique views and per-channel sharing counters are now
connected to the shared Interaction Platform.
