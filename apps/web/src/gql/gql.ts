...
type Documents = {
    ...
    "query MediaLibrary($input: MediaLibraryInput) {\n  mediaLibrary(input: $input) {\n    items {\n      id\n      ownerId\n      kind\n      status\n      visibility\n      originalFilename\n      mimeType\n      extension\n      size\n      width\n      height\n      failureCode\n      createdAt\n      updatedAt\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n  mediaLibraryMetrics {\n    totalMedia\n    originalBytes\n    variantBytes\n    totalBytes\n    orphanedMedia\n    failedMedia\n    quarantinedMedia\n  }\n}\n\nmutation RetryFailedMedia($mediaId: ID!) {\n  retryFailedMedia(mediaId: $mediaId) {\n    id\n    status\n    failureCode\n    updatedAt\n  }\n}": typeof types.MediaLibraryDocument,
    "query Viewer {\n  viewer {\n    id\n    username\n    displayName\n    email\n    avatarUrl\n    status\n    createdAt\n  }\n}": typeof types.ViewerDocument,
};
const documents: Documents = {
    "query ApiInfo {\n  apiInfo {\n    name\n    status\n    transport\n  }\n}": types.ApiInfoDocument,
    "mutation Login($input: LoginInput!) {\n  login(input: $input) {\n    user {\n      id\n      username\n      displayName\n      email\n    }\n    tokens {\n      accessToken\n      refreshToken\n    }\n  }\n}\n\nmutation Register($input: RegisterInput!) {\n  register(input: $input) {\n    user {\n      id\n      username\n      displayName\n      email\n    }\n    tokens {\n      accessToken\n      refreshToken\n    }\n  }\n}": types.LoginDocument,
    "query MediaLibrary($input: MediaLibraryInput) {\n  mediaLibrary(input: $input) {\n    items {\n      id\n      ownerId\n      kind\n      status\n      visibility\n      originalFilename\n      mimeType\n      extension\n      size\n      width\n      height\n      failureCode\n      createdAt\n      updatedAt\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n  mediaLibraryMetrics {\n    totalMedia\n    originalBytes\n    variantBytes\n    totalBytes\n    orphanedMedia\n    failedMedia\n    quarantinedMedia\n  }\n}\n\nmutation RetryFailedMedia($mediaId: ID!) {\n  retryFailedMedia(mediaId: $mediaId) {\n    id\n    status\n    failureCode\n    updatedAt\n  }\n}": types.MediaLibraryDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query MediaLibrary($input: MediaLibraryInput) {\n  mediaLibrary(input: $input) {\n    items {\n      id\n      ownerId\n      kind\n      status\n      visibility\n      originalFilename\n      mimeType\n      extension\n      size\n      width\n      height\n      failureCode\n      createdAt\n      updatedAt\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n  mediaLibraryMetrics {\n    totalMedia\n    originalBytes\n    variantBytes\n    totalBytes\n    orphanedMedia\n    failedMedia\n    quarantinedMedia\n  }\n}\n\nmutation RetryFailedMedia($mediaId: ID!) {\n  retryFailedMedia(mediaId: $mediaId) {\n    id\n    status\n    failureCode\n    updatedAt\n  }\n}"): (typeof documents)["query MediaLibrary($input: MediaLibraryInput) {\n  mediaLibrary(input: $input) {\n    items {\n      id\n      ownerId\n      kind\n      status\n      visibility\n      originalFilename\n      mimeType\n      extension\n      size\n      width\n      height\n      failureCode\n      createdAt\n      updatedAt\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n  mediaLibraryMetrics {\n    totalMedia\n    originalBytes\n    variantBytes\n    totalBytes\n    orphanedMedia\n    failedMedia\n    quarantinedMedia\n  }\n}\n\nmutation RetryFailedMedia($mediaId: ID!) {\n  retryFailedMedia(mediaId: $mediaId) {\n    id\n    status\n    failureCode\n    updatedAt\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
