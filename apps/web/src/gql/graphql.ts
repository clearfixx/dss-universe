...
export type NewsCatalogQuery = { news: { total: number, page: number, pageSize: number, totalPages: number, items: Array<{ id: string, interactionTargetId: string, postType: NewsPostType, language: string, slug: string, title: string, shortText: string, coverMediaId: string | null, displayPublishedAt: unknown, featured: boolean, author: { id: string, username: string, displayName: string | null, avatarUrl: string | null }, primaryCategory: { id: string, name: string, slug: string, icon: string | null } | null, tags: Array<{ id: string, name: string, slug: string }>, engagement: { viewCount: number | null, commentCount: number, upvotes: number, downvotes: number, score: number, bookmarkedByViewer: boolean, viewerReaction: NewsVoteKind | null } }> }, newsSettings: { newsPaginationMode: NewsPaginationMode, newsPaginationThreshold: number, newsPageSize: number } };
