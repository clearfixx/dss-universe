...
export type ProfileWallQuery = { profileWall: { total: number, page: number, limit: number, totalPages: number, items: Array<{ id: string, profileOwnerId: string, authorId: string, body: string | null, imageMediaId: string | null, isDeleted: boolean, deletedAt: string | null, createdAt: string, updatedAt: string }> } };
...
export type MembersDirectoryQuery = { members: { total: number, page: number, limit: number, totalPages: number, items: Array<{ id: string, username: string, displayName: string | null, avatarUrl: string | null, isOnline: boolean, roles: Array<string>, createdAt: string }> }, presenceSummary: { onlineMembers: number, onlineGuests: number, onlineCrawlers: number, totalOnline: number, sampledAt: unknown } };
...
export type CreateProfileWallPostMutation = { createProfileWallPost: { id: string, profileOwnerId: string, authorId: string, body: string | null, imageMediaId: string | null, isDeleted: boolean, createdAt: string, updatedAt: string } };
