...
`WIKI` and trusted `ADMIN` documents additionally support DSS-owned tables,
task lists, paired footnotes and a generated table of contents. These nodes are
kept out of News, Forum and compact profiles so document-grade complexity does
not leak into every editor surface.
